...
void bubble_sort(int arr[], int n, int *comp, int *trocas) {
    int i, j;
    *comp = 0;
    *trocas = 0;
    for (i = 0; i < n; i++) {
...
int main() {
    ...
    // Medição de desempenho para Bubble Sort
    desempenho(bubble_sort, aleatorio_arr, vector_size, &comp, &trocas, &tempo_execucao);
    printf("Bubble Sort\n");
